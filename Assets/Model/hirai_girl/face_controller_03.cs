...
public class face_controller_03 : MonoBehaviour {
		...
		if (face_controll) {
			...
			if (eye_controll) {
				if (Input.GetKeyDown (KeyCode.JoystickButton0)) {
					ReplaceMaterial (eye_index, eye_tex_01);
				...
				if (Input.GetKeyDown (KeyCode.JoystickButton1)) {
					ReplaceMaterial (eye_index, eye_tex_02);
					eye_tex_01_flag = false;
					eye_tex_02_flag = false;
					eye_tex_03_flag = false;
					eye_tex_04_flag = false;
				...
				if (Input.GetKeyDown (KeyCode.JoystickButton2)) {
					ReplaceMaterial (eye_index, eye_tex_03);
					eye_tex_01_flag = false;
					eye_tex_02_flag = false;
					eye_tex_03_flag = false;
					eye_tex_04_flag = false;
				...
				if (Input.GetKey (KeyCode.JoystickButton3)) {
					ReplaceMaterial (eye_index, eye_tex_04);
					eye_tex_01_flag = false;
					eye_tex_02_flag = false;
					eye_tex_03_flag = false;
					eye_tex_04_flag = false;
			...
			if (mouth_controll) {
				if (Input.GetKeyDown (KeyCode.JoystickButton0)) {
					ReplaceMaterial (face_index, mouth_tex_01);
				...
				if (Input.GetKeyDown (KeyCode.JoystickButton1)) {
					ReplaceMaterial (face_index, mouth_tex_02);
					mouth_tex_01_flag = false;
					mouth_tex_02_flag = false;
					mouth_tex_03_flag = false;
					mouth_tex_04_flag = false;
				...
				if (Input.GetKeyDown (KeyCode.JoystickButton2)) {
					ReplaceMaterial (face_index, mouth_tex_03);
					mouth_tex_01_flag = false;
					mouth_tex_02_flag = false;
					mouth_tex_03_flag = false;
					mouth_tex_04_flag = false;
				...
				if (Input.GetKey (KeyCode.JoystickButton3)) {
					ReplaceMaterial (face_index, mouth_tex_04);
					mouth_tex_01_flag = false;
					mouth_tex_02_flag = false;
					mouth_tex_03_flag = false;
					mouth_tex_04_flag = false;
