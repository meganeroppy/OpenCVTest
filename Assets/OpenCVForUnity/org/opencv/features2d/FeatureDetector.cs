...
namespace OpenCVForUnity
{
    ...
    public class FeatureDetector : DisposableOpenCVObject
    {
        ...
        // internal usage only
        public static FeatureDetector __fromPtr__ (IntPtr addr)
        {
        ...
        public static FeatureDetector create (int detectorType)
        {
            ...
            FeatureDetector retVal = FeatureDetector.__fromPtr__ (features2d_FeatureDetector_create_10 (detectorType));
