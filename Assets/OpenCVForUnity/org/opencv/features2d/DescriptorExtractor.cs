...
namespace OpenCVForUnity
{
    ...
    public class DescriptorExtractor : DisposableOpenCVObject
    {
        ...
        // internal usage only
        public static DescriptorExtractor __fromPtr__ (IntPtr addr)
        {
        ...
        public static DescriptorExtractor create (int extractorType)
        {
            ...
            DescriptorExtractor retVal = DescriptorExtractor.__fromPtr__ (features2d_DescriptorExtractor_create_10 (extractorType));
