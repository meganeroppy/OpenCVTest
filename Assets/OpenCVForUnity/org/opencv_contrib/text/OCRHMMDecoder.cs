...
namespace OpenCVForUnity
{
    ...
    public class OCRHMMDecoder : BaseOCR
    {
        ...
        public static OCRHMMDecoder create (string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)
        {
            ...
            OCRHMMDecoder retVal = OCRHMMDecoder.__fromPtr__ (text_OCRHMMDecoder_create_11 (filename, vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj));
