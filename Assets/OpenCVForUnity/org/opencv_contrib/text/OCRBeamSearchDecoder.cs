...
namespace OpenCVForUnity
{
    ...
    public class OCRBeamSearchDecoder : BaseOCR
    {
        ...
        public static OCRBeamSearchDecoder create (string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)
        {
            ...
            OCRBeamSearchDecoder retVal = OCRBeamSearchDecoder.__fromPtr__ (text_OCRBeamSearchDecoder_create_11 (filename, vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj));
