...
namespace OpenCVForUnity
{
    ...
    public class Ximgproc
    {
        ...
        ContourFitting retVal = ContourFitting.__fromPtr__(ximgproc_Ximgproc_createContourFitting_11());
        ...
        DTFilter retVal = DTFilter.__fromPtr__(ximgproc_Ximgproc_createDTFilter_11(guide.nativeObj, sigmaSpatial, sigmaColor));
        ...
        EdgeBoxes retVal = EdgeBoxes.__fromPtr__(ximgproc_Ximgproc_createEdgeBoxes_11());
        ...
        FastGlobalSmootherFilter retVal = FastGlobalSmootherFilter.__fromPtr__(ximgproc_Ximgproc_createFastGlobalSmootherFilter_11(guide.nativeObj, lambda, sigma_color));
        ...
        FastLineDetector retVal = FastLineDetector.__fromPtr__(ximgproc_Ximgproc_createFastLineDetector_11());
        ...
        GraphSegmentation retVal = GraphSegmentation.__fromPtr__(ximgproc_Ximgproc_createGraphSegmentation_11());
        ...
        SuperpixelLSC retVal = SuperpixelLSC.__fromPtr__(ximgproc_Ximgproc_createSuperpixelLSC_11(image.nativeObj));
        ...
        SuperpixelSEEDS retVal = SuperpixelSEEDS.__fromPtr__(ximgproc_Ximgproc_createSuperpixelSEEDS_11(image_width, image_height, image_channels, num_superpixels, num_levels));
        ...
        SuperpixelSLIC retVal = SuperpixelSLIC.__fromPtr__(ximgproc_Ximgproc_createSuperpixelSLIC_11(image.nativeObj));
