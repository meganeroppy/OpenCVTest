...
namespace OpenCVForUnity
{
    ...
    public class Aruco
    {
        ...
        Dictionary retVal = Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_1from_10(nMarkers, markerSize, baseDictionary.getNativeObjAddr()));
        ...
        Dictionary retVal = Dictionary.__fromPtr__(aruco_Aruco_custom_1dictionary_10(nMarkers, markerSize));
